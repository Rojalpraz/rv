            ...
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div className="flex lg:flex-1">
                    <a href="#" className="-m-1.5 p-1.5">
                        ...
                        <img className=" w-auto" src="https://preview.colorlib.com/theme/capitalshop/assets/img/logo/logo.png" alt="" />
                    </a>
                </div>
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:gap-10">
